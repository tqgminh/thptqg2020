...
public class PhysicalEducationStudent {
	...
	public PhysicalEducationStudent() throws NumberFormatException, IOException {
		File file = new File("data\\PhysicalEducationChart.txt");
